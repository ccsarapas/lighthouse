...
- [`summary_report()`](https://ccsarapas.github.io/lighthouse/reference/summary_report.md)
  [`nom()`](https://ccsarapas.github.io/lighthouse/reference/summary_report.md)
  [`bin()`](https://ccsarapas.github.io/lighthouse/reference/summary_report.md)
  [`cont()`](https://ccsarapas.github.io/lighthouse/reference/summary_report.md)
...
- [`fct_case_when()`](https://ccsarapas.github.io/lighthouse/reference/fct_case_when.md)
...
- [`try_numeric()`](https://ccsarapas.github.io/lighthouse/reference/try_numeric.md)
  [`try.numeric()`](https://ccsarapas.github.io/lighthouse/reference/try_numeric.md)
...
- [`add_empty_rows()`](https://ccsarapas.github.io/lighthouse/reference/add_empty_rows.md)
  : Add empty rows
...
- [`fct_filter()`](https://ccsarapas.github.io/lighthouse/reference/fct_filter.md)
  : Filter by and drop factor levels simultaneously
- [`filter_drop()`](https://ccsarapas.github.io/lighthouse/reference/filter_drop.md)
  : Filter by and drop a column simultaneously
- [`group_split_named()`](https://ccsarapas.github.io/lighthouse/reference/group_split_named.md)
...
- [`reorder_dendro_by_label()`](https://ccsarapas.github.io/lighthouse/reference/reorder_dendro_by_label.md)
...
- [`is_valid()`](https://ccsarapas.github.io/lighthouse/reference/is_valid.md)
  [`is.valid()`](https://ccsarapas.github.io/lighthouse/reference/is_valid.md)
...
- [`str_collapse()`](https://ccsarapas.github.io/lighthouse/reference/str_collapse.md)
...
- [`d_to_OR()`](https://ccsarapas.github.io/lighthouse/reference/d_to_OR.md)
  [`OR_to_d()`](https://ccsarapas.github.io/lighthouse/reference/d_to_OR.md)
...
- [`accuracy_stats()`](https://ccsarapas.github.io/lighthouse/reference/accuracy_stats.md)
...
- [`` `%<-%` ``](https://ccsarapas.github.io/lighthouse/reference/unpack-assign.md)
  [`` `%->%` ``](https://ccsarapas.github.io/lighthouse/reference/unpack-assign.md)
  : Unpack and assign
- [`` `%!in%` ``](https://ccsarapas.github.io/lighthouse/reference/not-in.md)
  : Match values not in vector
- [`` `%all_in%` ``](https://ccsarapas.github.io/lighthouse/reference/any-all-in.md)
  [`` `%any_in%` ``](https://ccsarapas.github.io/lighthouse/reference/any-all-in.md)
...
- [`untidyselect()`](https://ccsarapas.github.io/lighthouse/reference/untidyselect.md)
  : Convert a tidy selection to a vector of column names
- [`zap_everything()`](https://ccsarapas.github.io/lighthouse/reference/zap_everything.md)
...
- [`gain_missing_codes`](https://ccsarapas.github.io/lighthouse/reference/gain_missing_codes.md)
  : Missing codes for GAIN ABS
- [`holidays_chestnut`](https://ccsarapas.github.io/lighthouse/reference/holidays_chestnut.md)
  : CHS holidays over a 20-year period
- [`holidays_il`](https://ccsarapas.github.io/lighthouse/reference/holidays_il.md)
  : Illinois state holidays over a 20-year period
- [`holidays_us`](https://ccsarapas.github.io/lighthouse/reference/holidays_us.md)
  : US federal holidays over a 20-year period
- [`state.terr.name`](https://ccsarapas.github.io/lighthouse/reference/territory.md)
  [`state.terr.abb`](https://ccsarapas.github.io/lighthouse/reference/territory.md)
  [`state.terr.data`](https://ccsarapas.github.io/lighthouse/reference/territory.md)
  : US state and territory data

## Deprecated

- [`get_col_types()`](https://ccsarapas.github.io/lighthouse/reference/get_col_types.md)
